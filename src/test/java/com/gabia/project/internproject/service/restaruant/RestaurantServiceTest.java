...
import com.gabia.project.internproject.service.restaruant.dto.RestaurantTopStarDtoV1;
import com.gabia.project.internproject.service.restaruant.dto.TopStarColumnDto;
...
class RestaurantServiceTest {
    ...
    public void 별점높은가게리스트테스트(){
        ...
        for (TopStarColumnDto restaurant : re.getRestaurants()) {
